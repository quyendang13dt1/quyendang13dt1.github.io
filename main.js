...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                _ip_service__WEBPACK_IMPORTED_MODULE_18__["IpService"]
            ],
...
var ContactDetailComponent = /** @class */ (function () {
    ...
    ContactDetailComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: "<p>Name: {{name}}, phoneNumber:  {{phoneNumber}}</p>",
...
var LearnPipeComponent = /** @class */ (function () {
    function LearnPipeComponent() {
        this.birthday = new Date(2018, 5, 17);
        this.person = { name: 'Quyen', age: 23 };
        this.address = Promise.resolve('177 Hung Vuong');
    }
...
var ListPersonComponent = /** @class */ (function () {
    ...
    ListPersonComponent.prototype.removePersonByName = function (name) {
        var index = this.arrayPerson.findIndex(function (element) { return element.name === name; });
...
var SignInComponent = /** @class */ (function () {
    ...
    SignInComponent.prototype.postToExpress = function () {
        ...
        // const body = JSON.stringify({name:'Dang Quyen'});
...
var UserFormComponent = /** @class */ (function () {
    function UserFormComponent() {
        ...
        this.currentClass = { circle: true, square: false };
    }
...
module.exports = "<h3>{{ getMessage()}}</h3>\n<input type=\"text\" placeholder=\"Enter your city\" [(ngModel)] = \"txtCityName\">\n<br>\n<br>\n<button (click) = \"getWeather()\">Get weather</button>\n"
...
var WeatherComponent = /** @class */ (function () {
    ...
    WeatherComponent.prototype.ngOnInit = function () {
        ...
        // .then(temp_local => console.log(temp_local))
    ...
    WeatherComponent.prototype.getWeather = function () {
        ...
        this.weatherService.getTemp(this.txtCityName)
            .then(function (temp_local) {
            _this.cityName = _this.txtCityName;
            _this.temp = temp_local;
...
var WeatherService = /** @class */ (function () {
    ...
    WeatherService.prototype.getTemp = function (cityName) {
        var url = 'http://api.openweathermap.org/data/2.5/weather?appid=9ba0025ec627420c1e9a77152fa50cb6&units=metric&q=' + cityName;
...
module.exports = "<h3 [hidden] = \"forgot\">This is Word component</h3>\r\n<h3>{{en}}</h3>\r\n<p>{{vn}}</p>\r\n<button (click)=\"toggleForgot()\">Toggle forgot</button>"
...
module.exports = "<div *ngIf = \"isShowForm\">\n    <input placeholder=\"NewEnglish\" [(ngModel)]=\"newEn\">\n    <br>\n    <input placeholder=\"NewEnglish\" [(ngModel)]=\"newVn\">\n    <br>\n    <button (click)=\"addWord();\">addWord</button>\n</div>\n<br>\n<button (click)=\"isShowForm = true\" *ngIf = \"!isShowForm\" >addWord</button>\n<br>\n<select [(ngModel)] = \"filterSattus\">\n  <option value=\"viewAll\">View all word</option>\n  <option value=\"viewWordRemember\">View remember word</option>\n  <option value=\"viewWordNotRemember\">View not remember word</option>\n</select>\n<div *ngFor = \"let words of arrWords\" >\n  <div class=\"word\" *ngIf=\"allowView(words.memorized)\">\n    <h3 [ngStyle] = \"{color: words.memorized ? 'red' : 'blue'}\">{{words.en}}</h3>\n    <p>{{words.vn}}</p>\n    <button (click)=\"RemoveWord(words.id);\">Delete</button>\n    <button (click)=\"words.memorized = !words.memorized\">\n      {{words.memorized ? 'Remember' : 'notRemember'}}\n    </button>\n  </div>\n</div>\n"
...
var WordsComponent = /** @class */ (function () {
    ...
    WordsComponent.prototype.RemoveWord = function (id) {
        var index = this.arrWords.findIndex(function (test) { return test.id == id; });
        console.log(index);
        this.arrWords.splice(index, 1);
    };
    WordsComponent.prototype.allowView = function (memorized) {
        var conditionAll = this.filterSattus === 'viewAll';
        var conditionRemember = this.filterSattus === 'viewWordRemember' && memorized;
        var conditionNotRemember = this.filterSattus === 'viewWordNotRemember' && !memorized;
        // console.log(conditionRemember);
        return conditionAll || conditionRemember || conditionNotRemember;
    };
...
module.exports = __webpack_require__(/*! C:\Users\User\Desktop\learn-angular\src\main.ts */"./src/main.ts");
